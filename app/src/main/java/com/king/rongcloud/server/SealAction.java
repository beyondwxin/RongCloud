package com.king.rongcloud.server;

import android.content.Context;
import android.text.TextUtils;
import android.util.Log;

import com.king.rongcloud.server.network.http.HttpException;
import com.king.rongcloud.server.request.AddGroupMemberRequest;
import com.king.rongcloud.server.request.AddToBlackListRequest;
import com.king.rongcloud.server.request.AgreeFriendsRequest;
import com.king.rongcloud.server.request.ChangePasswordRequest;
import com.king.rongcloud.server.request.CheckPhoneRequest;
import com.king.rongcloud.server.request.CreateGroupRequest;
import com.king.rongcloud.server.request.DeleteFriendRequest;
import com.king.rongcloud.server.request.DeleteGroupMemberRequest;
import com.king.rongcloud.server.request.DismissGroupRequest;
import com.king.rongcloud.server.request.FriendInvitationRequest;
import com.king.rongcloud.server.request.JoinGroupRequest;
import com.king.rongcloud.server.request.LoginRequest;
import com.king.rongcloud.server.request.QuitGroupRequest;
import com.king.rongcloud.server.request.RegisterRequest;
import com.king.rongcloud.server.request.RemoveFromBlacklistRequest;
import com.king.rongcloud.server.request.RestPasswordRequest;
import com.king.rongcloud.server.request.SendCodeRequest;
import com.king.rongcloud.server.request.SetFriendDisplayNameRequest;
import com.king.rongcloud.server.request.SetGroupDisplayNameRequest;
import com.king.rongcloud.server.request.SetGroupNameRequest;
import com.king.rongcloud.server.request.SetGroupPortraitRequest;
import com.king.rongcloud.server.request.SetNameRequest;
import com.king.rongcloud.server.request.SetPortraitRequest;
import com.king.rongcloud.server.request.VerifyCodeRequest;
import com.king.rongcloud.server.response.AddGroupMemberResponse;
import com.king.rongcloud.server.response.AddToBlackListResponse;
import com.king.rongcloud.server.response.AgreeFriendsResponse;
import com.king.rongcloud.server.response.ChangePasswordResponse;
import com.king.rongcloud.server.response.CheckPhoneResponse;
import com.king.rongcloud.server.response.CreateGroupResponse;
import com.king.rongcloud.server.response.DefaultConversationResponse;
import com.king.rongcloud.server.response.DeleteFriendResponse;
import com.king.rongcloud.server.response.DeleteGroupMemberResponse;
import com.king.rongcloud.server.response.DismissGroupResponse;
import com.king.rongcloud.server.response.FriendInvitationResponse;
import com.king.rongcloud.server.response.GetBlackListResponse;
import com.king.rongcloud.server.response.GetFriendInfoByIDResponse;
import com.king.rongcloud.server.response.GetGroupInfoResponse;
import com.king.rongcloud.server.response.GetGroupMemberResponse;
import com.king.rongcloud.server.response.GetGroupResponse;
import com.king.rongcloud.server.response.GetTokenResponse;
import com.king.rongcloud.server.response.GetUserInfoByIdResponse;
import com.king.rongcloud.server.response.GetUserInfoByPhoneResponse;
import com.king.rongcloud.server.response.GetUserInfosResponse;
import com.king.rongcloud.server.response.JoinGroupResponse;
import com.king.rongcloud.server.response.LoginResponse;
import com.king.rongcloud.server.response.QiNiuTokenResponse;
import com.king.rongcloud.server.response.QuitGroupResponse;
import com.king.rongcloud.server.response.RegisterResponse;
import com.king.rongcloud.server.response.RemoveFromBlackListResponse;
import com.king.rongcloud.server.response.RestPasswordResponse;
import com.king.rongcloud.server.response.SendCodeResponse;
import com.king.rongcloud.server.response.SetFriendDisplayNameResponse;
import com.king.rongcloud.server.response.SetGroupDisplayNameResponse;
import com.king.rongcloud.server.response.SetGroupNameResponse;
import com.king.rongcloud.server.response.SetGroupPortraitResponse;
import com.king.rongcloud.server.response.SetNameResponse;
import com.king.rongcloud.server.response.SetPortraitResponse;
import com.king.rongcloud.server.response.SyncTotalDataResponse;
import com.king.rongcloud.server.response.UserRelationshipResponse;
import com.king.rongcloud.server.response.VerifyCodeResponse;
import com.king.rongcloud.server.response.VersionResponse;
import com.king.rongcloud.server.utils.NLog;
import com.king.rongcloud.server.utils.json.JsonMananger;
...
public class SealAction extends BaseAction {
    ...
    public CheckPhoneResponse checkPhoneAvailable(String region, String phone) throws HttpException {
        String url = getURL("user/checkPhoneAvailable");
    ...
    public SendCodeResponse sendCode(String region, String phone) throws HttpException {
        String url = getURL("user/sendCode");
    ...
    * */
    ...
    public VerifyCodeResponse verifyCode(String region, String phone, String code) throws HttpException {
        String url = getURL("user/verifyCode");
    ...
    public GetTokenResponse getToken() throws HttpException {
        String url = getURL("user/getToken", new String[]{});
