package com.king.rongcloud.view.fragment;
...
import com.king.rongcloud.server.SealAction;
import com.king.rongcloud.server.broadcast.BroadcastManager;
import com.king.rongcloud.server.network.async.AsyncTaskManager;
import com.king.rongcloud.server.network.async.OnDataListener;
...
import com.king.rongcloud.view.AccountSettingActivity;
import com.king.rongcloud.view.MyAccountActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mine_service:
                ...
                builder.province("北京");
                builder.city("北京");
                RongIM.getInstance().startCustomerServiceChat(getActivity(), "KEFU149423207484812", "在线客服", builder.build());
                // KEFU146001495753714 正式  KEFU145930951497220 测试  小能: zf_1000_1481459114694   zf_1000_1480591492399

                CSCustomServiceInfo.Builder csBuilder = new CSCustomServiceInfo.Builder();
                CSCustomServiceInfo csInfo = csBuilder.nickName("融云").build();
                RongIM.getInstance().startCustomerServiceChat(getActivity(), "KEFU149423207484812", "在线客服",csInfo);
                break;
            case R.id.mine_xiaoneng:
                CSCustomServiceInfo.Builder csBuilder2 = new CSCustomServiceInfo.Builder();
                CSCustomServiceInfo csInfo2 = csBuilder2.nickName("融云").build();
                RongIM.getInstance().startCustomerServiceChat(getActivity(), "KEFU149423207484812", "在线客服",csInfo2);
                break;
